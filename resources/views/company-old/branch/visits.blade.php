    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Branches Visits</h4>
        ...
        $(document).ready(function () {
            ...
            var dataTable = $('#visitDT').DataTable({
                ...
                columns: [
                    ...
                    {data: 'branch', name: 'branch.branch_name', title: 'Branch', class: 'text-center', orderable: false},
                    {data: 'questionnaire', name: 'questionnaire.name', title: 'Questionnaire', class: 'text-center', orderable: false},
                ...
                ajax: {
                    url: '{{ route("company.branches.visits.list",$branch_id) }}',
                    type: "POST",
                    dataType: "JSON",
                    data: function (f) {
                        f._token = "{{csrf_token()}}";
