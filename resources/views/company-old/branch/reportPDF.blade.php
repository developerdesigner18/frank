...
<head>
    ...
    <style>
        ...
        .red { background-color: #FC0B15; }
        .orange { background-color: #F99B16; }
        .yellow { background-color: #FED21A; color: #000; }
        .lightgreen { background-color: #AAC1BB; color: #000; }
...
{{--                <img src="{{ public_path('assets/logo/kompaan2.png') }}" style="width: 250px;">--}}
            ...
            <td style="width: 50%;">
                <div class="card-border">
                    ...
                    <p style="font-size: 18px">{{ $visitData->visit->branch->address_1??'' }} {{ $visitData->visit->branch->locality??'' }}</p>
                    <p style="font-size: 18px">{{ $visitData->visit->branch->postal_code??'' }}</p>
                </div>
            </td>
        </tr>
    </table>
                ...
                <div class="card-container" style="margin-top: 10px;">
                    <table class="header-table">
                        <tr>
                            ...
                            <td align="right"><div class="score-box" style="background-color: #f8aa2f;">{{ $final_score }}%</div></td>
{{--                            <td align="right"><div class="score-box" style="background-color: #f8aa2f;">{{ $visitData->total_score ? $visitData->total_score-2:0 }}%</div></td>--}}
                    ...
                    <div class="bar-container">
                        <div class="pointer" style="left: {{ $final_score>0? $final_score-2 :0 }}%;"></div>
...
@if($response_data['question'])
    @foreach($response_data['question'] as $category => $questions)
        ...
        <div class="visit-container">
            <div>
                <h1 class="visit-title">{{$title}} &nbsp;&nbsp; {{ $final_score>0? $final_score.'%':'' }}</h1>
            </div>
            <div>
                <img src="{{ $main_logo }}" class="checkmark">
            </div>
        ...
        <div>
            <h3>{{ $response_data['category']->$category ?? 'Unknown' }}</h3>
