                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="p-2 mt-4">
                                <form id="loginForm">
                                    ...
                                    <div class="mb-3">
                                        <div class="float-end">
                                            <a href="{{route('company.forget.password.get')}}" class="text-muted">Forgot password?</a>
                                        </div>
                                    ...
                                    <div class="mt-4">
                                        <button type="submit" class="btn btn-primary w-100 rounded-pill"
                                                id="loginButton"><i class="bx bx-loader spinner me-2"
                                                                    style="display: none" id="loginBtnSpinner"></i>Log
                                            In
                                        </button>
                                    </div>
                                </form>
