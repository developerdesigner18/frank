...
@section('title','In Progress Visit')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">In Progress Visit</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">In Progress Visit</a></li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <script !src="">
        $(document).ready(function () {
            ...
            var dataTable = $('#visitDT').DataTable({
                ...
                ajax: {
                    url: '{{ route("admin.visit.inProgress.list") }}',
                    type: "POST",
                    dataType: "JSON",
                    data: function (f) {
                        f._token = "{{csrf_token()}}";
