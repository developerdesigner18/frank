                            ...
                            <div class="mb-3">
                                ...
                                <div class="image-upload-container">
                                    ...
                                    <div class="image-preview mt-2" id="categoryImagePreview" style="display: none;">
                                        <img src="{{ asset('assets/logo/placeholder.svg') }}" alt="Category preview"
                                             class="img-thumbnail"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="image-upload-container">
                                ...
                                <div class="image-preview mt-2" id="questionImagePreview" style="display: none;">
                                    <img src="{{ asset('assets/logo/placeholder.svg') }}" alt="Question preview"
                                         class="img-thumbnail"
...
@section('script')
    <script>
        $(document).ready(function () {
            $('#openModalBtn').on('dblclick', function () {
                console.log('dd');
                $('#myModal').modal('show');
            });
        });
    ...
    <script>
        ...
        $('#openCategoryEditModalBtn').on('dblclick', function () {
            $('#myModal').modal('show');
        });
        ...
        function renderCategoryTabs() {
            ...
            categories.forEach((category) => {
                ...
                const tab = $(`
                    <div class="category-tab ${isActive ? "active" : ""}" data-category-id="${category.id}" data-category-name="${category.name}" data-category-image="${category.imageUrl}" id="">
...
<!--                            <input type="range" class="form-range slider-input" min="${minScore}" max="${maxScore}" step="${question.step}" value="${minScore}">-->
        ...
        $(document).on("click", ".saveButton", (e) => {
            ...
            $.ajax({
                url: "{{route('admin.questionnaire.save')}}", // Your save endpoint
                method: "POST",
                dataType: "json",
                data: data,
                processData: false,
