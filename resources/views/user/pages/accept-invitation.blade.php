            ...
            <div class="w-full max-w-md">
                <div class="bg-white shadow-lg rounded-2xl p-4 md:p-8">
                    <div class="flex flex-col items-center pb-4">
                        <img alt="CheckMyZaak logo" class=" h-10 sm:h-12 w-auto"
                    ...
                    <div class="flex gap-2">
                        <a href="{{ route('company.lang.switch', ['locale' => 'en', 'redirect' => url()->full()]) }}"
                            class="cursor-pointer px-4 py-2 rounded-lg font-medium transition-colors
       {{ get_current_locale() === 'en' ? 'bg-[#0073AF] text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' }}' }}">EN</a>
                        

                        <a href="{{ route('company.lang.switch', ['locale' => 'nl', 'redirect' => url()->full()]) }}"
                           class="cursor-pointer px-4 py-2 rounded-lg font-medium transition-colors
                    ...
                    <form class="flex flex-col gap-4" id="registerForm">
                        ...
                        <div>
                            <label class="text-xs sm:text-sm font-medium text-gray-700"
                                for="first_name">{{ trans_message('first_name') }}</label>
                            <input autocomplete="first_name"
                                ...
                                id="first_name" name="first_name" placeholder="{{ trans_message('first_name') }}"
                                type="text">
                        ...
                        <div>
                            <label class="text-xs sm:text-sm font-medium text-gray-700"
                                for="last_name">{{ trans_message('last_name') }}</label>
                            <input autocomplete="last_name"
                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-sm"
                                id="last_name" name="last_name" placeholder="{{ trans_message('last_name') }}"
                                type="text">
                        ...
                        <div>
                            <label class="text-xs sm:text-sm font-medium text-gray-700"
                                for="email">{{ trans_message('email') }}</label>
                            <input autocomplete="email"
                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-sm"
                                id="email" name="email" value="{{ $decrypt }}" placeholder="you@example.com"
                                type="email" readonly>
                        ...
                        <div>
                            <div class="flex items-center justify-between">
                                <label class="text-xs sm:text-sm font-medium text-gray-700"
                                    for="password">{{ trans_message('password') }}</label>
                            </div>
                        ...
                        <div>
                            <div class="flex items-center justify-between">
                                <label class="text-xs sm:text-sm font-medium text-gray-700"
                                    for="password_confirmation">{{ trans_message('confirm_pass') }}</label>
                            </div>
                            <input autocomplete="confirmation-password"
                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-sm"
                                id="password_confirmation" name="password_confirmation"
                                placeholder="{{ trans_message('confirm_pass') }}" type="password">
                            <label id="password_confirmation-error" class="text-[red] error"
                        ...
                        <div>
                            <label class="text-xs sm:text-sm font-medium text-gray-700"
                                for="mobile_number">{{ trans_message('mobile_number') }}</label>
                            <input autocomplete="mobile_number"
                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-sm"
                                id="mobile_number" name="mobile_number"
                                placeholder="{{ trans_message('mobile_number') }}" type="tel">
                        ...
                        <div class="flex flex-col gap-1">
                            <label class="block text-sm font-medium text-gray-700"
                                for="remuneration_method">{{ trans_message('remuneration_me') }}</label>
                            <div class="relative">
                        ...
                        <div class="">
                            ...
                            <label class="form-check-label" for="terms-agreed-check">{{ trans_message('i_agree_to_the_terms_and_conditions') }}</label>
                        ...
                        <div>
                            <input class="form-check-input" type="checkbox" value="1"
                                name="receive_new_visit_emails" id="receive-mail">

                            <label class="form-check-label" for="receive-mail">
                                {{ trans_message('i_want_to_receive_emails_when_new_mysteryare_mystery_visit_is_available') }}
                            </label>

                            <label id="receive-mail-error" class="text-[red] error" for="receive-mail"
                                style="display: none"></label>
                        </div>
