            ...
            <div class="relative">
                <button popovertarget="desktop-menu-user"
                    ...
                    <div
                        ...
                        <img src="{{ auth('web')->user()->profile_image ?? asset('assets/user/image/user.png') }}"
                             alt="">
                    </div>
                    <p class="text-sm font-medium text-gray-700">
                        {{ trim(auth('web')->user()->first_name . ' ' . auth('web')->user()->last_name) ?: '-' }}
                    </p>
                ...
                <el-popover id="desktop-menu-user" anchor="bottom-end" popover
                    ...
                    <div class="flex flex-col w-full gap-2">
                        <div class="flex flex-col justify-center">
                            ...
                            <p class="text-xs text-[#606266] pb-2 text-center">{{auth('web')->user()->email}}</p>
                            <span
                                    class="px-[11px] text-[#409eff] bg-[#ecf5ff] border border-[#d9ecff] h-[32px] text-[12px] rounded-[4px] font-medium items-center flex  m-auto">
                                            <span class="el-tag__content"> Visitor</span>
                                        </span>
