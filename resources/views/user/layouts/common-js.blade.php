<script>
    ...
    function initDropify(className = '.dropify'){
        $(className).dropify({
            messages: {
                'default': '<i class="ri-upload-cloud-line me-1"></i> Drag and drop a file or click to browse',
                'replace': '<i class="ri-refresh-line me-1"></i> Drag and drop or click to replace',
                'remove': '<i class="ri-delete-bin-line"></i>',
                'error': '<i class="ri-alert-line me-1"></i> Oops, something went wrong'
            },
            error: {
                'fileSize': 'The file size is too big (2MB max).',
                'fileExtension': 'Only jpg, jpeg, png files are allowed.',
                'imageFormat': 'Only jpg, jpeg, png images are allowed.'
            }
        });
    }
</script>
