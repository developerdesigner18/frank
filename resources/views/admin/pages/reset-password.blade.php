        ...
        <div class="w-full max-w-md">
            <div class="bg-white shadow-lg rounded-2xl p-4 md:p-8">
                <div class="flex flex-col items-center pb-4">
                    ...
                    <p class=" text-xs sm:text-sm text-center text-gray-500 pt-1">Your new password must be different
                        from previous used password</p>
                </div>
    ...
    $(document).ready(function () {
        $("#loginForm").validate({
            ...
            submitHandler: function (form, e) {
                e.preventDefault();
                $.ajax({
                    url: "{{route('admin.reset.password.post')}}",
                    method: "post",
                    dataType: "json",
