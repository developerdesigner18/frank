                                        ...
                                        <div>
                                            @if(isset($qus['answer_image']) && !empty($qus['answer_image']))
                                                @if (file_exists(public_path(SURVEY_QUESTIONNAIRE_IMAGES_PATH) . basename($qus['answer_image'])))
                                                    {{-- Client request: Portrait photos, moderately larger --}}
                                                    <img src="{{ public_path(SURVEY_QUESTIONNAIRE_IMAGES_PATH.basename($qus['answer_image'])) }}" width="300" height="375" style="object-fit: contain;">
                                                @endif
                                            @endif
                                        </div>
                                    @endif
                                            ...
                                            @foreach($qus['photo'] as $image)
                                                @if ($image && $image != null && $image != '')
                                                    @if (file_exists(public_path(SURVEY_QUESTIONNAIRE_IMAGES_PATH) . $image))
                                                        {{-- Client request: Portrait photos, moderately larger --}}
                                                        <img src="{{ public_path(SURVEY_QUESTIONNAIRE_IMAGES_PATH.$image) }}" width="300" height="375" style="object-fit: contain; margin-bottom: 10px;">
                                                    @endif
                                                @endif
                                            @endforeach
                                        </div>
