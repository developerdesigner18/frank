...
@push('navbar')
    <div class="pt-6 flex justify-between items-center lg:hidden">
        ...
        <div class="relative w-auto">
            <button command="show-modal" commandfor="add-admin-model"
...
@push('modal')
    ...
    <el-dialog>
        <dialog id="add-admin-model" aria-labelledby="dialog-title"
                        ...
                        <div class="sm:flex flex-col sm:items-start">
                            <div class="flex pb-4 justify-between w-full items-center">
                                <h3 class="text-base font-semibold text-gray-800">
                                    {{ trans_message('add_admin_user') }}
                                </h3>
                                <button type="button" command="close" commandfor="add-admin-model"
                            ...
                            <form class="w-full" id="addAdminForm">
                                ...
                                <div class="flex flex-col items-center">
                                    <div class="relative">
                                        <div id="add-preview-container"
                                            ...
                                            <svg id="add-default-icon" class="w-12 h-12 text-gray-400"
                                                 xmlns="http://www.w3.org/2000/svg"
                                                 viewBox="0 0 24 24" fill="currentColor">
                                                <path d="M12 12C14.7614 12 17 9.76142 17 7C17 4.23858 14.7614 2 12 2C9.23858 2 7 4.23858 7 7C7 9.76142 9.23858 12 12 12Z"/>
                                                <path d="M12 14C7.58172 14 4 17.5817 4 22H20C20 17.5817 16.4183 14 12 14Z"/>
                                            </svg>
                                            <img id="add-preview-image" src="" alt="Preview"
                                                 class="hidden w-full h-full object-cover"/>
                                        </div>

                                        <input type="file" id="add-file-input" accept=".jpeg,.jpg,.png,.gif,.avif,.svg"
                                ...
                                <div class="flex flex-col gap-1">
                                    ...
                                    <input type="email" name="email"
                                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                           placeholder="{{ trans_message('enter_email') }}">
                                ...
                                <div class="flex flex-col gap-1">
                                    ...
                                    <label id="password-error" class="text-[red] error" for="password" style="display: none"></label>
                                </div>
                                ...
                                <div class="flex flex-col gap-1">
                                    ...
                                    <label id="password_confirmation-error" class="text-[red] error" for="password_confirmation" style="display: none"></label>
                                </div>
    ...
    <el-dialog>
        <dialog id="edit-admin-model" aria-labelledby="dialog-title"
                class="fixed inset-0 size-auto max-h-none max-w-none overflow-y-auto bg-transparent backdrop:bg-transparent">
            <el-dialog-backdrop
                    class="fixed inset-0 bg-gray-900/50 transition-opacity data-closed:opacity-0 data-enter:duration-300 data-enter:ease-out data-leave:duration-200 data-leave:ease-in"></el-dialog-backdrop>
                ...
                <el-dialog-panel
                    ...
                    <div class="bg-white relative px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="sm:flex flex-col sm:items-start">
                            <div class="flex pb-4 justify-between w-full items-center">
                                <h3 class="text-base font-semibold text-gray-800">
                                    {{ trans_message('edit_admin_user') }}
                                </h3>
                                <button type="button" command="close" commandfor="edit-admin-model"
                                        class="rounded-full p-2 text-gray-800 hover:bg-gray-200 transition-all duration-300 cursor-pointer absolute right-3 top-3">
                                    <svg class="size-[18px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                         fill="currentColor">
                                        <path d="M11.9997 10.5865L16.9495 5.63672L18.3637 7.05093L13.4139 12.0007L18.3637 16.9504L16.9495 18.3646L11.9997 13.4149L7.04996 18.3646L5.63574 16.9504L10.5855 12.0007L5.63574 7.05093L7.04996 5.63672L11.9997 10.5865Z">
                            ...
                            <form class="w-full" id="editAdminForm">
                                ...
                                <div class="flex flex-col gap-1 pb-4">
                                    <label class="block text-sm font-medium text-gray-700">{{ trans_message('name') }}</label>
                                    <input type="text" id="editAdminName" name="name"
                                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                           placeholder="{{ trans_message('enter_name') }}">
                                    <label id="editName-error" class="text-[red] error" for="editName" style="display: none"></label>
                                </div>

                                <!-- Email -->
                                <div class="flex flex-col gap-1 pb-4">
                                    <label class="block text-sm font-medium text-gray-700">{{ trans_message('email') }}</label>
                                    <input type="email" id="editAdminEmail" name="email"
                                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                           placeholder="{{ trans_message('enter_email') }}">
                                    <label id="editEmail-error" class="text-[red] error" for="editEmail" style="display: none"></label>
                                </div>
                                ...
                                <div class="flex flex-col gap-1 pb-4">
                                    ...
                                    <input type="password" name="password"
                                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                           placeholder="{{ trans_message('leave_blank_to_keep_current') }}">
                                    <label id="editPassword-error" class="text-[red] error" for="editPassword" style="display: none"></label>
                                </div>
                                ...
                                <div class="flex flex-col gap-1 pb-4">
                                    ...
                                    <input type="password" name="password_confirmation"
                                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                           placeholder="{{ trans_message('confirm_password') }}">
                                    <label id="editPasswordConfirmation-error" class="text-[red] error" for="editPasswordConfirmation" style="display: none"></label>
                                </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
            <div class="p-4 sm:p-6">
                <div class="overflow-x-auto">
                    <table id="adminUsersTable" class="w-full display">
                        <thead>
                        <tr>
                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ trans_message('profile') }}</th>
                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ trans_message('name') }}</th>
                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ trans_message('email') }}</th>
                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ trans_message('created_at') }}</th>
                            <th class="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">{{ trans_message('actions') }}</th>
                        </tr>
                        </thead>
                        <tbody></tbody>
                    </table>
...
@section('script')
    <script>
        ...
        const addDefaultIcon = document.getElementById("add-default-icon");
        ...
        addFileInput.addEventListener("change", function () {
            ...
            if (file) {
                ...
                reader.onload = function (e) {
                    ...
                    addPreviewImage.classList.remove("hidden");
                    addDefaultIcon.classList.add("hidden");
                };
        ...
        $(document).ready(function () {
            ...
            table = $('#adminUsersTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.admin-users.list') }}",
                columns: [
                ...
                order: [[3, 'desc']],
                language: {
                    emptyTable: "{{ trans_message('no_data_available') }}",
            ...
            $("#addAdminForm").validate({
                ...
                messages: {
                    ...
                    password_confirmation: {
                        required: "{{ trans_message('confirm_password_required') }}",
        ...
        function editAdmin(id) {
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $('#editAdminName').val(result.data.name);
                    $('#editAdminEmail').val(result.data.email);
                    
                    // Set profile image
                    if (result.data.profile_img) {
                        editPreviewImage.src = result.data.profile_img;
                        editPreviewImage.classList.remove("hidden");
                        editDefaultIcon.classList.add("hidden");
                    }
                    
                    // Open modal
                    document.querySelector('[commandfor="edit-admin-model"]').click();
                },
                error: function (xhr) {
                    actionError(xhr);
                }
        ...
        function deleteAdmin(id) {
            Swal.fire({
                ...
                confirmButtonClass: "btn-primary px-4 py-2 text-sm font-medium text-white bg-red-600 border border-red-600 rounded-lg hover:bg-red-700 cursor-pointer",
                cancelButtonClass: "bg-gray-100 border border-gray-300 btn-secondary cursor-pointer font-medium hover:bg-gray-200 ml-3 px-4 py-2 rounded-lg text-gray-700 text-sm",
        ...
        function resetAddForm() {
            ...
            addDefaultIcon.classList.remove("hidden");
            $('.error').hide();
        }
        ...
        function resetEditForm() {
            ...
            editDefaultIcon.classList.remove("hidden");
            $('.error').hide();
        }
    </script>
@endsection
