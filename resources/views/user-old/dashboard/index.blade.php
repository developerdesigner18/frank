                    ...
                    <div class="col-12">
                        <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                            <div class="flex-grow-1">
                                <h4 class="fs-16 mb-1">Welcome
                                    Abord, {{Auth::guard('web')->user()->first_name.' '.Auth::guard('web')->user()->last_name}}
                                    !</h4>
                            </div>
                        </div>
                        <!-- end card header -->
                    ...
                    <div class="col-xl-3 col-md-6">
                        ...
                        <div class="card card-animate">
                            <div class="card-body">
                              ...
                              >
                                <i class="ri-table-line text-success"></i>
                              </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card card-animate">
                            <div class="card-body">
                                ...
                                >
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4">
                                <span class="counter-value" data-target="{{ $scheduled }}"
                                >0</span
                                >
                                        </h4>
                        ...
                        <div class="card card-animate">
                            <div class="card-body">
                                ...
                                >
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4">
                                <span class="counter-value" data-target="{{ $pending }}"
                                >0</span
                                >
                                        </h4>
                                    </div>
...
@section('script')
    <script !src="">
        $(document).ready(function () {
            sendToast('Welcome abord!', 'primary');
        });
    </script>
@endsection
